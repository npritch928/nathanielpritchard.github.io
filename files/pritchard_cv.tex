...
\begin{document}  
\name{\hspace{0.05in} Nathaniel Pritchard \\  \hspace{0.45in} Janurary 2025}
...
%\vspace{0.1in}
``Who needs a residual when an approximation will do?`` December 2024 at Numerical Analysis Intertal Seminar in Oxford, UK.
